    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indicative_price', models.DecimalField(decimal_places=0, max_digits=9)),
                ('price_margin', models.DecimalField(decimal_places=0, max_digits=9)),
                ('waiting_period', models.IntegerField()),
                ('minimum_age', models.IntegerField()),
                ('maximum_age', models.IntegerField()),
                ('is_active', models.BooleanField(default=True)),
                ('note', models.TextField()),
                ('medication_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='medical.medicationtype')),
                ('molecule', models.ManyToManyField(blank=True, null=True, to='medical.molecule')),
                ('therapeutic_route', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='medical.therapeuticroute')),
            ],
            options={
